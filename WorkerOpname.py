...
class WorkerThread(QThread):
    ...
    def run(self):
        ...
        query = "select id_stok, id_katalog, id_lokasi, id_satuan, kodebarang, nama_barang, nama_merek,jumlah, keterangan,lokasi FROM daftar_stok LIMIT %s OFFSET %s;"
...
class WorkerSQL(QThread):
    ...
    def run(self):
        mydb = connection.Connect()
        mycursor = mydb.cursor()
        mycursor.execute("SELECT total_stok, stok_page FROM Count_Query;")
        myresult = mycursor.fetchall()
