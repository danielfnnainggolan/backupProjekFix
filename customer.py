...
from WorkerPrice import WorkerPageCustomer, WorkerCustomer
...
class CustomerFunction(QWidget):
    ...
    def loadDataWorker(self):
        ...
        self.worker = WorkerCustomer(0,25)
    ...
    def loadPageWorker(self):
        ...
        self.workerPage = WorkerPageCustomer()
    ...
    def pageClicked(self, page_number, limit):
        ...
        page_number-=1
        self.worker = WorkerCustomer(page_number, limit)
        self.worker.start()
        self.worker.result.connect(self.handle_result)
    ...
    def pageStart(self):
        self.current_page = 1
        self.worker = WorkerCustomer(0, 0)
        self.worker.start()
        self.worker.result.connect(self.handle_result)
    ...
    def pageEnd(self):
        ...
        self.worker = WorkerCustomer(self.total_page-1, 25) #page number,limit
        self.worker.start()
        self.worker.result.connect(self.handle_result)
