...
class SatuanBarangFunction(QWidget):
    ...
    def deleteWindow(self):
        ...
        msgBox.setInformativeText("Nama Satuan : "+" "+self.data[1])
        ...
        if msgBox.clickedButton() == buttonY:
            mydb = connection.Connect()
            mycursor = mydb.cursor()
            mycursor.execute("UPDATE satuan_ukur SET deleted_At = %s WHERE id= %s ;", (datetime.now(timezone('Asia/Jakarta')), self.data[0]))
            mydb.commit()
            mycursor.close()
            mydb.close()
            msgBox1 = QMessageBox()
...
class Add(QDialog):
    def __init__(self, parent):
        ...
        self.setWindowTitle("Tambah Satuan Ukur")
        self.editLine.setPlaceholderText("Cth: cm , m , liter")
    ...
    def Add_line_edit(self):
        ...
        line_edit.setPlaceholderText("Cth: cm , m , liter")
    ...
    def Add_Action(self):
        ...
        mycursor = mydb.cursor()
        try:
            query = "INSERT INTO satuan_ukur (satuan_ukur) VALUES (%s)"
...
class Edit(QDialog):
    def __init__(self, parent):
        ...
        self.setWindowTitle("Ubah Satuan Spesifikasi Barang")
        self.editLine.setPlaceholderText("Ubah Satuan Spesifikasi Barang")
    ...
    def Edit_Action(self, edit_array):
        ...
        mydb = connection.Connect()
        mycursor = mydb.cursor()
        query = "UPDATE satuan_ukur SET satuan_ukur = %s WHERE id = %s "
